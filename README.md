# Projeto Integrador 1 - UNIVESP - Polo Suzano

Desenvolvimento de sistema web de gestão interativa da grade horária numa instituição de ensino básico municipal*

DRP1 - Projeto Integrador em computação I da UNIVESP (Universidade Virtual do Estado de São Paulo) - Polo Suzano - Turma 007 Grupo 018.
*Desenvolver um software acessível que permitirá inserir, atualizar, excluir e consultar dados de através de uma interface interativa que irá integrar a grade horária das disciplinas eletivas dos docentes e de outras atividades. A solução será escalável e de fácil manutenção, visando atender às necessidades da instituição de ensino de forma eficaz e eficiente, facilitando o acesso a essas informações a qualquer momento e online.*

Orientadora: [Laura Parisi](github.com/LucianocLopes/DRP01-PJIC1-T7-G18)
...
- [Lila Mina Harada, 2215902](github.com/lilaharada)
- [Luciano da Cunha Lopes, 2219248](github.com/LucianocLopes)
- [Otávio Augusto Costa, 2227674](github.com/otaviocosta25)

Links do projeto:
(<https://github.com/LucianocLopes/DRP01-PJIC1-T7-G18>)

- [Documentação (esse documento)](github.com/LucianocLopes/DRP01-PJIC1-T7-G18)
